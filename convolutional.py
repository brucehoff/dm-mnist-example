...
#
#
# NOTE:  This is a MODIFICATION of the original demo to work with the 
# DREAM Digital Mammography submission pipeline
#
# ==============================================================================
...
BATCH_SIZE = 64
NUM_EPOCHS = 1 # temporarily reduced from 10 to speed testing
EVAL_BATCH_SIZE = 64
...
def main(argv=None):  # pylint: disable=unused-argument
  if FLAGS.self_test:
    ...
    # Get the data.
    # NOTE:  In this modification of the script the data is already downloaded
  ...
  with tf.Session() as sess:
    ...
    # TODO write out model state to /output/working/model
